...
def send_email(subject, detail):
    ...
    msg['From'] = Header('Hello W汇报人 <%s>' % sender, 'utf-8')
    msg['To'] = Header('Hello W订阅者', 'utf-8')
...
if __name__ == "__main__":
    ...
    detail = """
    欢迎访问：www.Hello W.cn
    这里是 keyL-liucong 的学习小册，记录前端学习的知识体系
...
if __name__ == "__main__":
    ...
    detail = """
    <div>欢迎访问：<a href="http://www.Hello W.cn" target="_blank">www.Hello W.cn</a></div>
    <div style='margin-bottom:5px'>这里是 keyL-liucong 的学习小册，记录前端学习的知识体系。</div>
    """
    send_email(email_title, detail)
```
