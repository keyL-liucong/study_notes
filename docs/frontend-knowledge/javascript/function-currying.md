...
// 测试一下
const uri1 = url('https://', 'www.Hello W.cn', '/function-curring/')
console.log(uri1)
```
...
const uri1 = uri_https('www.Hello W.cn', '/frontend-knowledge/javascript/function-currying/');
const uri2 = uri_https('www.Hello W.cn', '/handwritten/javascript/10-实现bind方法/');
const uri3 = uri_https('www.keyL-liucongblog.com', '/');
